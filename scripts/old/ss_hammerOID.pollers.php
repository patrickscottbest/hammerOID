...
//	hammerOID_debug("hammerOID - ss_hammerOID.pollers.php NOT called by script server"); 
...
//	hammerOID_debug("hammerOID - ss_hammerOID.pollers.php called by script server"); 
...
function ss_hammerOID_pollers( $cmd, $arg1 = '', $arg2 = '') {
	...
	if (($cmd == 'index')) {
		...
		//hammerOID_debug("ss_hammerOID.pollers.php Received a \"get\" command"); 
		...
		if (isset($exists_already)) {
			...
			//hammerOID_debug("ss_hammerOID.pollers.php - \"get\" - couldn't find a matching row"); 
		...
		//hammerOID_debug("ss_hammerOID.pollers.php Didn't receive a command"); 
	}
